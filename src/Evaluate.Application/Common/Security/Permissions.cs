...
public static class Permissions
{
    ...
    public static class AcademicYears { public const string Create = "AcademicYears.Create"; public const string View = "AcademicYears.View"; }
    public static class Terms { public const string Create = "Terms.Create"; public const string View = "Terms.View"; }
    ...
    [
        AcademicYears.Create, AcademicYears.View,
        Terms.Create, Terms.View,
